...
export default function CollectionContent() {
  ...
  return (
    <main id="main-content">
      ...
      {(['pool-tables', 'game-room-furniture', 'game-tables', 'cue-sticks', 'accessories', 'darts', 'used-pool-tables'] as const).map((slug) => categories.find((c) => c.slug === slug)!).map((category, index) => {
