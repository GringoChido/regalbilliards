        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface rounded-xl border border-border p-6 text-center">
              ...
              <h3 className="font-heading text-lg text-primary mb-2">Lifetime structural warranty</h3>
              <p className="text-sm text-text-muted">Covers the frame, slate, and structural components against defects in materials and workmanship for the life of the table.</p>
            </div>
            <div className="bg-surface rounded-xl border border-border p-6 text-center">
              <Building2 className="w-10 h-10 text-accent mx-auto mb-4" />
              <h3 className="font-heading text-lg text-primary mb-2">Manufacturer backed</h3>
              <p className="text-sm text-text-muted">Each manufacturer handles warranty claims directly. We work with them on your behalf to make the process simple.</p>
            </div>
            <div className="bg-surface rounded-xl border border-border p-6 text-center">
              <Wrench className="w-10 h-10 text-accent mx-auto mb-4" />
              <h3 className="font-heading text-lg text-primary mb-2">Local service support</h3>
              <p className="text-sm text-text-muted">Because we're local, warranty service is handled quickly. Our factory-trained technicians do the work on-site.</p>
            </div>
          </div>

          <div className="bg-primary/5 rounded-xl p-8">
            <h2 className="font-heading text-2xl text-primary mb-4">What's typically covered</h2>
          ...
          <div className="bg-surface rounded-xl border border-border p-8">
            <h2 className="font-heading text-2xl text-primary mb-4">What's typically not covered</h2>
