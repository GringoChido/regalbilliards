...
export const categories: CategoryInfo[] = [
  ...
  },
  {
    ...
    name: {
      en: 'Game Room Furniture',
      es: 'Muebles para Sala de Juegos',
    },
    description: {
  ...
  },
  {
    ...
    description: {
      en: 'Foosball, air hockey, shuffleboard, and multi-game tables for the ultimate game room. Fun for the whole family.',
      es: 'Futbolito, hockey de aire, shuffleboard y mesas multi-juego para la sala de juegos definitiva. Diversion para toda la familia.',
    },
    image: '/images/categories/game-tables.jpg',
  },
  {
    slug: 'darts',
    name: {
    ...
    description: {
      en: 'Professional bristle dartboards, electronic boards, cabinet sets, and steel-tip and soft-tip dart sets for every skill level.',
      es: 'Dianas profesionales de cerdas, tableros electronicos, sets de gabinete y juegos de dardos de punta de acero y punta suave para todos los niveles.',
    },
    image: '/images/categories/darts.jpg',
  },
  {
    slug: 'accessories',
    name: {
